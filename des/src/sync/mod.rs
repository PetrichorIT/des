...
//!
//! *A drop-in replacement for tokio::sync for a simulation context.*
//!
...
pub use tokio::sync::futures;
pub use tokio::sync::oneshot;
pub use tokio::sync::watch;

pub use tokio::sync::AcquireError;
pub use tokio::sync::TryAcquireError;
pub use tokio::sync::TryLockError;

pub use tokio::sync::MappedMutexGuard;
pub use tokio::sync::Mutex;
pub use tokio::sync::MutexGuard;
pub use tokio::sync::OwnedMutexGuard;

pub use tokio::sync::Barrier;
pub use tokio::sync::BarrierWaitResult;

pub use tokio::sync::Notify;
pub use tokio::sync::OnceCell;
pub use tokio::sync::SetError;

pub use tokio::sync::OwnedRwLockMappedWriteGuard;
pub use tokio::sync::OwnedRwLockReadGuard;
pub use tokio::sync::OwnedRwLockWriteGuard;
