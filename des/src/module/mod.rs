...
//! lifecycle. Abstractions for sending and receiving messages can be found in the [`message` module](crate::message).
//!
...
//!
//! A module context is usually created automatically when using the [`Sim`](crate::runtime::Sim) builder,
